...
struct Manager {
	...
	static let staticConstant = "some constant"
	static var staticVariable = "some varieble"


}

Manager.staticVariable = "dicks"

//Manager.staticVariable/
print(Manager.staticConstant)
print(Manager.staticVariable)
